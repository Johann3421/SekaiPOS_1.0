...
namespace SekaiPOS_1._0
{
    public class ReceiptForm : Form
    {
        ...
        public ReceiptForm(DatabaseHelper database, int id)
        {
            db = database;
            saleId = id;
            InitializeComponent();
        ...
        private void GenerateReceipt()
        {
            ...
            receipt.AppendLine("========================================");
            receipt.AppendLine("          SEKAI POS - TIENDA           ");
            receipt.AppendLine("       ELECTRÓNICA Y TECNOLOGÍA        ");
            receipt.AppendLine("========================================");
            receipt.AppendLine();
            ...
            receipt.AppendLine("     Visítenos nuevamente pronto      ");
            receipt.AppendLine("========================================");
